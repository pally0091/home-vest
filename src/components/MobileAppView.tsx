...
const MobileAppView: React.FC = () => {
  ...
  // };
  return (
    <div className="mt-20 mb-10 pt-16 pb-56">
      <div className="max-w-[1500px] mx-auto flex flex-col lg:flex-row align-middle items-center justify-center gap-10 lg:gap-64">
        <div className="text-left ">
          <p className="text-[15px] text-[#ee7214]">Getting started is easy</p>
          <h3 className="text-[36px] font-bold my-5 max-w-[450px]">
            The Convenience You’d Expect from a Modern Investment Platform
          </h3>
          <p className="text-[15px] max-w-[564px]">
            Our state of the art platform allows investors to purchase
            SEC-compliant shares in a secure, convenient environment.
          </p>
          <button className="bg-[#EE7214] text-white py-[10px] px-5 rounded-[9px] flex items-center mt-[30px]">
            Browse Properties{" "}
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="mt-10 relative">
          <img
            ...
            alt=""
          />
          <div className="w-[259px] h-[137px] shadow-2xl shadow-gray-200 bg-white rounded-[10px] z-10 absolute top-44 -left-40">
            <div className="w-[259px] h-[137px] p-2 relative">
              <div className="w-[24px] h-[2px] bg-[#ee7214] mb-2"></div>
              <p className="text-[14px] text-justify max-w-[259px] absolute pr-2 z-10">
                Our team of property professionals combine a data driven
                valuation and analysis process with over 20 years of leadership.
              </p>
              <div className="h-[31px] w-[31px] bg-white rotate-45 absolute top-1/2 -right-7 transform -translate-x-1/2 -translate-y-1/2"></div>
            </div>
          </div>
          <div className="w-[80px] h-[80px] absolute left-2 -top-10">
            <img className="w-full h-full" src="/images/Frame 27.png" alt="" />
          </div>
          <div className="w-[110px] h-[110px] absolute bottom-28 -right-8">
            <img className="w-full h-full" src="/images/Frame 26.png" alt="" />
          </div>
        </div>
      </div>
